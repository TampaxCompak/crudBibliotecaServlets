        ...
        switch (action) {
            case "add":
                ...
                if (usuario == null || ejemplar == null) {
                    ...
                    List<Prestamo> prestamosActivos = daoPrestamo.getPrestamosActivosPorUsuario(usuario.getId());
                    if (prestamosActivos.size() >= 3) {
                        json_response = conversorJson.writeValueAsString("Error: El usuario ya tiene 3 préstamos activos.");
                    } else {
            ...
            case "return":
                ...
                if (prestamoToReturn == null) {
                    ...
                    LocalDate fechaLimite = prestamoToReturn.getFechaInicio().plusDays(15);
